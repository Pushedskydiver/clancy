...
`/clancy:update` checks npm for a newer version of `chief-clancy`, shows the changelog diff, and re-runs the installer to update commands, workflows, and runtime scripts. It detects and backs up any user-modified files before overwriting.
