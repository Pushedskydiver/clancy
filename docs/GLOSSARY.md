...
| **Lock file** | `.clancy/clancy.lock` — written at the start of `/clancy:once`, deleted on success. Contains ticket key, branch, timestamp, and PID. Prevents double-runs and enables crash recovery. |
